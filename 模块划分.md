...
**当前可验证项**：`\scripts\test.ps1`（全量 161 用例全绿，F3 新增 `TestConnectionTests` 10 个 + `TestConnectionIntegrationTests` 2 个用例）；`\scripts\dev.ps1` 可进入登录页，用真账号 `000/0000` 登录后进入主面板占位页。
